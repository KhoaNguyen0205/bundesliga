...
<div class="col-md-3">
		...
		<c:if test="${not empty userobj}">
             	 ...
             	 <a href="" style="border: solid;color: black;" class="">${userobj.name}</a> 
					<a href="../login.jsp" style="border: solid;color: black;" class="">Logout</a>
  ...
  <nav>
    <ul class="menuItems">
      <li><a href="home.jsp" data-item='Home'>Home</a></li>
